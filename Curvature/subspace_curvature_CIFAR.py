...
if run_type <= 3: #mean curvature calculations
    ...
    if run_type == 0: # natural, paired
        ...
        origin_indices = get_origin_indices(model_madry, data_maddry, num_images, num_advs)[0]
        data_ = data_madry
        model_ = model_madry
    ...
    shape_operators, principal_curvatures, principal_directions = get_curvature(
        condition_zip, num_images, num_advs, condition_origin_indices, num_iters, num_steps_per_iter, autodiff=True)
