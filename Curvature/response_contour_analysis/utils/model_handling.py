    ...
    for target_index, target_dataset in enumerate(contour_dataset):
        ...
        for datapoints in target_dataset:
            ...
            if target_model_ids is not None:
                ...
                activations = get_activation_function(model, datapoints, neuron_index, **activation_function_kwargs).cpu().detach().numpy()
                ...
                activations = get_activation_function(model, datapoints, **activation_function_kwargs).cpu().detach().numpy()
